...
export class LeadsService {
  ...
  private get salesNumber(): string {
  ...
  async create(dto: CreateLeadDto, metadata?: { ipAddress?: string; userAgent?: string; referrer?: string }) {
    // Normalize phone
    ...
    const lead = await this.prisma.lead.create({
      data: {
        ...
        source:      (dto.source?.toUpperCase() as any) || 'WEBSITE',
        message:     dto.message,
